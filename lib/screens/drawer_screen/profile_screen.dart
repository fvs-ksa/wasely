  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<ProfileCubit,ProfileState>(
      ...
      builder: (context,state) {
        TextEditingController nameController = TextEditingController(text:profileCubit.profileModel.account!.fname );
        TextEditingController phoneController = TextEditingController(text: profileCubit.profileModel.account!.phone);
        return Scaffold(
          appBar: AppBar(
            title: Text('حسابي'),
          ),
