...
class SentOrderScreen extends StatefulWidget {
  String mealName;
  int mealPrice;
  int mealCount;
  SentOrderScreen({Key? key,required this.mealName,required this.mealCount,required this.mealPrice}) : super(key: key);

  @override
  State<SentOrderScreen> createState() => _SentOrderScreenState();
}

class _SentOrderScreenState extends State<SentOrderScreen> {
                  ...
                  children: [
                    ...
                    Align(alignment: Alignment.bottomCenter,child: mainButton(
                        ...
                        Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context)=>HomeScreen()), (route) => false);
                          showToast(text: 'تم رفع طلبكم في انتظار موافقه سائق', state: ToastState.SUCCESS);
                    }))
                  ],
                ),
              ),
